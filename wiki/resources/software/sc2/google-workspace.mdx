...
SC2 calendars are shared to specific users/groups, so head to [calendar.google.com](https://calendar.google.com) with your SC2 account to see what calendars you are a part of. The public SC2 calendar is available [here](https://scstem.org/calendar).
