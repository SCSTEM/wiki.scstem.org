...
import imgLayout from "./images/layout.png";
import imgMainEntrance from "./images/main-entrance.jpg";
...
<Image
  img={imgMainEntrance}
  alt="Brick building with a set of glass double-doors at the edge of a parking lot"
/>
...
See [Rooms](./rooms) for layout and scheduling specifics. General layout:

<Image
  img={imgLayout}
  alt="Diagram of the SC2 lower level workspace, includes FTC room, FLL/Classroom, FRC field, FRC room, shop & storage, and restrooms."
/>
